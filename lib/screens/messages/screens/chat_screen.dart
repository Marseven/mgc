...
import 'package:socialv/models/messages/FastMessageModel.dart';
...
import 'package:socialv/models/messages/StreamMessage.dart';
import 'package:socialv/models/messages/Threads.dart';
                ...
                children: [
                  if (thread!.permissions!.canReply.validate() && selectedMessage!.senderId.toString() != appStore.loginUserId)
                    InkWell(
                      ...
                      child: Icon(Icons.reply, size: 20, color: Colors.white),
                ...
                callback: (p0) async {
                  switch (p0) {
                    case ChatScreenPopUpMenuComponentCallbacks.MuteOrUnMute:
                      ...
                      break;
                    case ChatScreenPopUpMenuComponentCallbacks.AddParticipantsInChat:
              ...
              if (canReplyMsg != null && canReplyMsg!.userBlockedMessages != null)
                ...
                Positioned(
                  ...
                  child: WriteMessageComponent(
                    threadSecretKey: thread != null ? thread!.secret_key.validate() : "",
