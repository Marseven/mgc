...
import 'package:socialv/models/messages/BmBlockedUsers.dart';
import 'package:socialv/models/messages/Notifications.dart';
...
class _UserSettingsScreenState extends State<UserSettingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SnapHelperWidget<UserSettingsModel>(
        future: userSettings(),
        onSuccess: (snap) {
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                if (snap.bmBlockedUsers!.user.validate().isEmpty)
                  NoDataWidget(
                  ...
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                    physics: NeverScrollableScrollPhysics(),
                    itemCount: snap.bmBlockedUsers!.user.validate().length,
                    itemBuilder: (ctx, index) {
