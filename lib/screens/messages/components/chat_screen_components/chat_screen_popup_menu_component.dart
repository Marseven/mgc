...
import '../../../../models/messages/MessageUsers.dart';
import '../../../../models/messages/Threads.dart';
import '../../../../network/messages_repository.dart';
import '../../screens/participants_screen.dart';
import '../add_new_participant_component.dart';

enum ChatScreenPopUpMenuComponentCallbacks { MuteOrUnMute, AddParticipantsInChat, GetThread, SetState, DeleteThread }
...
class ChatScreenPopUpMenuComponent extends StatefulWidget {
  ...
  ChatScreenPopUpMenuComponent({Key? key, this.users, required this.thread, this.threadId, this.user, this.doRefresh, this.callback}) : super(key: key);
    ...
    return Theme(
      ...
      child: PopupMenuButton(
        ...
        itemBuilder: (context) => <PopupMenuEntry>[
          ...
          if (widget.thread.type == ThreadType.thread && widget.thread.participantsCount.validate() == 2)
            PopupMenuItem(
              value: 2,
              child: TextIcon(
