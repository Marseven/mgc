...
class _ChatScreenMessagesComponentState extends State<ChatScreenMessagesComponent> {
  ...
  Widget build(BuildContext context) {
    String textDate = widget.date == getChatDate(date: DateTime.now().toString()) ? 'Today' : widget.date.validate();
    ...
    return Column(
      children: [
        ...
        InkWell(
          ...
          child: ColoredBox(
            color: widget.message == widget.selectedMessage ? context.primaryColor.withAlpha(40) : context.scaffoldBackgroundColor,
            child: Align(
