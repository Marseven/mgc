                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          if (widget.post.isUserVerified.validate())
                      ...
                      child: PopupMenuButton(
                        ...
                        onSelected: (val) async {
                          if (val == 1) {
                            ...
                            AddPostScreen(
                              showMediaOptions: widget.post.type ==
                                      PostActivityType.activityShare
                                  ? false
                                  : true,
                              post: widget.post,
                              groupId: widget.groupId,
                              component: widget.groupId != null
                                  ? Component.groups
                                  : Component.members,
                              callback: () {
                                widget.callback?.call();
                            ...
                            AddPostScreen(
                              ...
                              parentPostId:
                                  widget.post.activityId.validate().toString(),
                              groupId: widget.groupId,
                              component: widget.groupId != null
                                  ? Component.groups
                                  : Component.members,
              ...
              if (widget.post.content.validate().isNotEmpty)
                if (widget.post.type == PostActivityType.newBlogPost)
                  InkWell(
                    ...
                    splashColor: Colors.transparent,
                    child:
                        HtmlWidget(postContent: widget.post.content.validate()),
                  )
                else
                  ReadMoreText(
                    parseHtmlString(
                        widget.post.content.validate().replaceAll("\n", '')),
                    style: primaryTextStyle(),
                    trimLines: 3,
              ...
              if (!widget.childPost.validate())
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        CommentScreen(postId: widget.post.activityId.validate())
                            .launch(context)
                            .then(
                          (value) {
                            if (value ?? false) widget.callback?.call();
                      ...
                      child: Text(
                          '${widget.post.commentCount} ${language.comments}',
                          style: secondaryTextStyle()),
                    ),
                  ],
                ).paddingSymmetric(horizontal: 8),
                        ...
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            ...
                            if (postLikeList.length > 1)
                              TextSpan(
                                  text:
                                      '${postLikeCount - 1} ${language.others}',
                                  style: boldTextStyle(
                                      size: 12, fontFamily: fontFamily)),
                          ],
                        ),
          ...
          children: [
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Text(language.reportPost, style: primaryTextStyle())
                    .center(),
